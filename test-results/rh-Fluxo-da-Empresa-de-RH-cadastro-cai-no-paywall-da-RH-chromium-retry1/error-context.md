...
- Name: rh.spec.ts >> Fluxo da Empresa de RH >> cadastro cai no paywall da RH
- Location: tests\rh.spec.ts:9:7
...
Locator: getByRole('button', { name: /assinar agora/i })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('button', { name: /assinar agora/i }) with timeout 5000ms
  - waiting for getByRole('button', { name: /assinar agora/i })
