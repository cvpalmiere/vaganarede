...
- Name: empresa.spec.ts >> Fluxo da Empresa >> acesso a /empresa/vagas continua bloqueado sem assinatura ativa
- Location: tests\empresa.spec.ts:26:7
...
Expected pattern: /\/empresa\/assinatura/
